  ...
  $.extend(DateTime.prototype, {
    ...
    _compareDates: function (a, b) {
      ...
      return dateLib && dateLib == window.luxon
        ? dateLib.DateTime.fromJSDate(a).toISODate() ===
            dateLib.DateTime.fromJSDate(b).toISODate()
    ...
    _setTime: function () {
      ...
      this._optionsTime(
        "minutes",
        60,
        luxDT != null ? luxDT.minute : d ? d.getUTCMinutes() : 0,
        allowed("minutes"),
        this.s.minutesRange
      );
      this._optionsTime(
        "seconds",
        60,
        luxDT != null ? luxDT.second : d ? d.getSeconds() : 0,
        allowed("seconds"),
        this.s.secondsRange
      );
    },
    ...
    _writeOutput: function (focus) {
      ...
      if (date) {
        out =
          dateLib && dateLib == window.luxon
            ? dateLib.DateTime.fromJSDate(this.s.d).toFormat(this.c.format)
            : dateLib
            ? dateLib
                .utc(date, undefined, this.c.locale, this.c.strict)
