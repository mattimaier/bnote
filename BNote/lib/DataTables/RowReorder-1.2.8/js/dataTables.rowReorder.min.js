...
(function (d) {
  ...
  var q = d.fn.dataTable,
    p = function (a, b) {
      if (!q.versionCheck || !q.versionCheck("1.10.8"))
        throw "DataTables RowReorder requires DataTables 1.10.8 or newer";
      this.c = d.extend(!0, {}, q.defaults.rowReorder, p.defaults, b);
      this.s = {
        bodyTop: null,
        dt: new q.Api(a),
      ...
      this.dom.dtScroll.length ||
        (this.dom.dtScroll = d(this.s.dt.table().container(), "tbody"));
      a.rowreorder = this;
      this._constructor();
    };
  d.extend(p.prototype, {
    ...
    _cachePositions: function () {
      var a = this.s.dt,
        ...
        c = d.unique(a.rows({ page: "current" }).nodes().toArray());
    ...
    _eventToPage: function (a, b) {
      return -1 !== a.type.indexOf("touch")
        ? a.originalEvent.touches[0]["page" + b]
        : a["page" + b];
    },
    _mouseDown: function (a, b) {
      ...
      f.offsetTop = g.top;
      f.offsetLeft = g.left;
      f.nodes = d.unique(e.rows({ page: "current" }).nodes().toArray());
      ...
      d(h)
        .on("mouseup.rowReorder touchend.rowReorder", function (k) {
          c._mouseUp(k);
        })
    ...
    _mouseMove: function (a) {
      this._clonePosition(a);
      for (
        var b = this._eventToPage(a, "Y") - this.s.bodyTop,
          c = this.s.middles,
          e = null,
          f = this.s.dt,
          g = 0,
      ...
      if (null === this.s.lastInsert || this.s.lastInsert !== e)
        (b = d.unique(f.rows({ page: "current" }).nodes().toArray())),
          e > this.s.lastInsert
    ...
    _mouseUp: function (a) {
      ...
      var g = this.s.start.nodes,
        k = d.unique(c.rows({ page: "current" }).nodes().toArray()),
        n = {},
        r = [],
        t = [],
        u = this.s.getDataFn,
        ...
        if (b.c.update) {
          ...
          for (e = r.length; l < e; l++) {
            ...
            c.columns().every(function () {
              this.dataSrc() === f &&
                c.cell(r[l].node, this.index()).invalidate("data");
            });
          }
      ...
      this.c.editor
        ? ((this.c.enable = !1),
          this.c.editor
            .edit(t, !1, d.extend({ submit: "changed" }, this.c.formOptions))
            .multiSet(f, n)
    ...
    _shiftScroll: function (a) {
      ...
      f < d(m).scrollTop() + 65
        ? (g = -5)
        : f > c.windowHeight + d(m).scrollTop() - 65 && (g = 5);
      null !== c.dtTop && a.pageY < c.dtTop + 65
        ? (k = -5)
        : null !== c.dtTop && a.pageY > c.dtTop + c.dtHeight - 65 && (k = 5);
      g || k
        ? ((c.windowVert = g), (c.dtVert = k), (e = !0))
      ...
      !this.s.scrollInterval &&
        ...
        (this.s.scrollInterval = setInterval(function () {
          if (c.windowVert) {
            ...
            n !== d(h).scrollTop() &&
              ((n = parseFloat(b.dom.clone.css("top"))),
              b.dom.clone.css("top", n + c.windowVert));
          }
          c.dtVert &&
            ((n = b.dom.dtScroll[0]), c.dtVert && (n.scrollTop += c.dtVert));
        }, 20));
    },
  });
  p.defaults = {
  ...
  v.register("rowReorder()", function () {
    return this;
  });
  ...
  d(h).on("init.dt.dtr", function (a, b, c) {
    "dt" === a.namespace &&
      ((a = b.oInit.rowReorder), (c = q.defaults.rowReorder), a || c) &&
      ((c = d.extend({}, a, c)), !1 !== a && new p(b, c));
  });
  return p;
});
