...
$jscomp.polyfillUnisolated = function (a, h, k, e) {
  ...
  h != e &&
    null != h &&
    $jscomp.defineProperty(k, a, { configurable: !0, writable: !0, value: h });
};
      ...
      e.prototype._addStyles = function () {
        ...
        for (
          var b = this.s.dt.columns().data().toArray().length,
            f = 0,
            l = 0,
            u = a(this.s.dt.table().node()).children("tbody").children("tr"),
            x = 0,
            A = new Map(),
            r = 0;
          r < b;
        ...
        this.s.dt.on("key-focus", function (g, m, n) {
          ...
          if (0 < d.c.left) {
            var c = a(d.s.dt.column(d.c.left - 1).header()),
              ...
              f = c.outerWidth();
            g.left < b.left + f &&
              ((c = m.scrollLeft()), m.scrollLeft(c - (b.left + f - g.left)));
          }
          0 < d.c.right &&
