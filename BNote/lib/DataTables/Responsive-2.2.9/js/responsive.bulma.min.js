...
(function (a) {
  "function" === typeof define && define.amd
    ...
    ? (module.exports = function (b, c) {
        b || (b = window);
        (c && c.fn.dataTable) || (c = require("datatables.net-bm")(b, c).$);
  ...
  c.modal = function (f) {
    return function (g, h, k) {
      h ||
        (f &&
          f.header &&
          ((h = d.find("div.modal-header")),
          h.find("button").detach(),
          h
            .empty()
            .append(
              '<h4 class="modal-title subtitle">' + f.header(g) + "</h4>"
            )),
        d.find("div.modal-body").empty().append(k()),
        d.appendTo("body"),
        d.addClass("is-active is-clipped"),
        a(".modal-close").one("click", function () {
          d.removeClass("is-active is-clipped");
        }),
        a(".modal-background").one("click", function () {
          d.removeClass("is-active is-clipped");
        }));
    };
  };
