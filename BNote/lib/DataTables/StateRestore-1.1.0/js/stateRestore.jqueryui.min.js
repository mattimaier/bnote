...
(function (b) {
  "function" === typeof define && define.amd
    ? define(
        ["jquery", "datatables.net-jq", "datatables.net-staterestore"],
        function (a) {
          return b(a);
        }
      )
    ...
    ? (module.exports = function (a, c) {
        a || (a = window);
        (c && c.fn.dataTable) || (c = require("datatables.net-jq")(a, c).$);
        c.fn.dataTable.StateRestore ||
          require("datatables.net-staterestore")(a, c);
        return b(c);
      })
    : b(jQuery);
})(function (b) {
  var a = b.fn.dataTable;
  b.extend(!0, a.StateRestoreCollection.classes, {
  ...
  b.extend(!0, a.StateRestore.classes, {
    confirmationButton:
