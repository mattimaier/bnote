...
(function () {
  ...
  var StateRestore = /** @class */ (function () {
    ...
    StateRestore.prototype.load = function () {
      ...
      $$1.fn.dataTable.ext.oApi._fnImplementState(
        settings,
        loadedState,
        function () {
  ...
  var StateRestoreCollection = /** @class */ (function () {
    ...
    StateRestoreCollection.prototype.addState = function (
      ...
      var createFunction = function (id, toggles) {
        ...
        var newState = new StateRestore(
          ...
          $.extend(true, {}, _this.c, toggles, options),
          id,
          currState,
          false,
          successCallback
    ...
    StateRestoreCollection.prototype.findActive = function () {
      ...
      var buttons = $(
        "button." +
          $.fn.DataTable.Buttons.defaults.dom.button.className.replace(
            / /g,
            "."
          )
      );
      ...
      if (this.s.states.length === 0) {
        stateButtons.push(
          '<span class="' +
            ...
            '">' +
            this.s.dt.i18n(
              "stateRestore.emptyStates",
              this.c.i18n.emptyStates
            ) +
            "</span>"
        );
      } else {
    ...
    StateRestoreCollection.prototype._creationModal = function (
      ...
      creationButton.on("click", function () {
        ...
        var saveState = {
          colReorder: _this.dom.colReorderToggle
            .children("input")
            .is(":checked"),
          columns: {
        ...
        var success = buttonAction(
          $("input." + _this.classes.nameInput.replace(/ /g, ".")).val(),
          { saveState: saveState }
        );
        if (success === true) {
