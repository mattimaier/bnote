...
(function (b) {
  "function" === typeof define && define.amd
    ? define(
        ["jquery", "datatables.net-se", "datatables.net-searchbuilder"],
        function (a) {
          return b(a);
        }
      )
  ...
  a.ext.buttons.searchBuilder.action = function (c, e, f, d) {
    c.stopPropagation();
    this.popover(d._searchBuilder.getNode(), {
      align: "container",
      span: "container",
    });
    void 0 !== d._searchBuilder.s.topGroup &&
      d._searchBuilder.s.topGroup.dom.container.trigger("dtsb-redrawContents");
    b("div.dtsb-searchBuilder").removeClass("ui basic vertical buttons");
  };
