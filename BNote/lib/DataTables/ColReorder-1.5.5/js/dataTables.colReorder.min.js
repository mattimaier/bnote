...
(function (e) {
    ...
    if (b != c)
      if (0 > b || b >= k)
        ...
        if (a.aoColumns[b].bVisible) {
          ...
          if (null !== a.nTFoot)
            for (
              m = a.nTFoot.getElementsByTagName("tr"), d = 0, g = m.length;
              d < g;
              d++
            )
              A(m[d], p, l);
        ...
        for (g = a.aoData.length; d < g; d++) {
          l = a.aoData[d];
          if ((n = l.anCells))
            for (v(n, b, c), m = 0, p = n.length; m < p; m++)
  ...
  e.extend(r.prototype, {
    ...
    _fnMouseMove: function (a) {
      ...
      m
        ? (this.dom.pointer.css("left", m.x), (this.s.mouse.toIndex = m.to))
    ...
    _fnCreateDragNode: function () {
      ...
      this.dom.pointer = e("<div></div>")
        ...
        .css({
          position: "absolute",
          top: a
            ? e(e(this.s.dt.nScrollBody).parent()).offset().top
            : e(this.s.dt.nTable).offset().top,
          height: a
            ? e(e(this.s.dt.nScrollBody).parent()).height()
