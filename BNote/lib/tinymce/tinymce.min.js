  ...
  r(l, [], function () {
    ...
    r(w, [x], function (e) {
      return function (t) {
        ...
        "onselectionchange" in t.getDoc() ||
          t.on("NodeChange Click MouseUp KeyUp Focus", function (n) {
            var i, o;
                    ...
                    if ((s = S.exec(f[i]))) {
                      ...
                      b &&
                        ("=" === b &&
                          ...
                          l.attributesDefault.push({ name: h, value: k }),
                          (c.defaultValue = k)),
                        ":" === b &&
                          ((l.attributesForced = l.attributesForced || []),
                          l.attributesForced.push({ name: h, value: k }),
                          (c.forcedValue = k)),
                        "<" === b && (c.validValues = a(k, "?"))),
                        T.test(h)
              ...
              if (
                ...
                if ((f = O[d])) {
                  (f.lastIndex = u = c.index + c[0].length),
                    (c = f.exec(e))
                      ? (k && (g = e.substr(u, c.index - u)),
                        (u = c.index + c[0].length))
                      : ((g = e.substr(u)), (u = e.length)),
                    k && (g.length > 0 && l.text(g, !0), l.end(d)),
                    (L.lastIndex = u);
                  continue;
                }
                w ||
        ...
        (r = r || {}),
          ...
          (u.parse = function (t, o) {
            ...
            if (
              ...
              for (N in p) {
                for (k = d[N], C = p[N], _ = C.length; _--; )
                  C[_].parent || C.splice(_, 1);
                for (x = 0, w = k.length; w > x; x++) k[x](C, N, o);
              }
              for (x = 0, w = f.length; w > x; x++)
                if (((k = f[x]), k.name in h)) {
                  for (C = h[k.name], _ = C.length; _--; )
                    C[_].parent || C.splice(_, 1);
                  for (_ = 0, E = k.callbacks.length; E > _; _++)
      ...
      return function (r, i) {
        ...
        function a(t) {
          ...
          (n = t.screenX - T),
            ...
            N[3] < 0 &&
              _.clientHeight <= O &&
              C.setStyle(_, "top", B + (H - O)),
            (n = U.scrollWidth - $),
            (r = U.scrollHeight - q),
            n + r !== 0 && C.setStyles(E, { left: a - n, top: s - r }),
            L ||
              (i.fire("ObjectResizeStart", { target: w, width: D, height: H }),
              (L = !0));
        }
        function s() {
          function e(e, t) {
      ...
      return function (a) {
        ...
        function y(e, t, n, r) {
          ...
          function o(n) {
            var i;
            return (
              at(l(n.parentNode).reverse(), function (n) {
                var o;
                i ||
                  "_start" == n.id ||
                  "_end" == n.id ||
          ...
          function u(e) {
            ...
            return (
              ot(n) && (n = n[e ? "firstChild" : "lastChild"]),
              U.remove(t, !0),
              n
            );
          }
        ...
        function H(t, n, r) {
          ...
          if (
            ...
            (g = c(g)),
            (y = c(y)),
            (ot(g.parentNode) || ot(g)) &&
              ((g = ot(g) ? g : g.parentNode),
              (g = g.nextSibling || g),
              3 == g.nodeType && (v = 0)),
            (ot(y.parentNode) || ot(y)) &&
              ((y = ot(y) ? y : y.parentNode),
        ...
        function W(t) {
          ...
          if (
            ...
            for (
              ...
              if (3 == a.nodeType && !B(a))
                return (
                  (l = U.create("a", { "data-mce-bogus": "all" }, G)),
    ...
    r(I, [d, u, k], function (e, t, n) {
      ...
      return (
        ...
        function (t) {
          function o() {
            var e = t.getContent({ format: "raw", no_events: 1 }),
      ...
      return function (i) {
        function o(o) {
          ...
          function C() {
            function e(e) {
              for (
                var t = L[e ? "firstChild" : "lastChild"];
                t && 1 != t.nodeType;
            ...
            /^(OL|UL|LI)$/.test(n) && (I = "LI"),
              ...
              e(!0) && e()
                ...
                : e()
                ? (a.insertAfter(H, t()), p(H))
                : ((L = t()),
                  (N = k.cloneRange()),
                  N.setStartAfter(A),
                  N.setEndAfter(L),
                  (M = N.extractContents()),
                  "LI" == I && "LI" == M.firstChild.nodeName
                    ? ((H = M.firstChild), a.insertAfter(M, L))
                    : (a.insertAfter(M, L), a.insertAfter(H, L))),
              a.remove(A),
              m(H),
              c.add();
          }
          ...
          if (((k = s.getRng(!0)), !o.isDefaultPrevented())) {
            ...
            if (
              ...
              if (
                ...
                (L = A ? a.getParent(A.parentNode, a.isBlock) : null),
                (P = A ? A.nodeName.toUpperCase() : ""),
                (O = L ? L.nodeName.toUpperCase() : ""),
                "LI" != O || o.ctrlKey || ((A = L), (P = O)),
                /^(LI|DT|DD)$/.test(P))
              ) {
                ...
                y()
                  ? ((H =
                      /^(H[1-6]|PRE|FIGURE)$/.test(P) && "HGROUP" != O
                        ? v(I)
                        : v()),
                    l.end_container_on_empty_block && f(L) && a.isEmpty(A)
                      ? (H = a.split(L, A))
                      : a.insertAfter(H, A),
                    m(H))
                  : y(!0)
                  ? ((H = A.parentNode.insertBefore(v(), A)), p(H), m(A))
                  : ((N = k.cloneRange()),
                    N.setEndAfter(A),
                    (M = N.extractContents()),
                    w(M),
        ...
        l(this, {
          ...
          C({
            ...
            mceInsertContent: function (t, n, o) {
              ...
              E === k &&
                S.isCollapsed() &&
                N.isBlock(k.firstChild) &&
                N.isEmpty(k.firstChild) &&
                ((y = N.createRng()),
                y.setStart(k.firstChild, 0),
              ...
              if (
                ...
                for (v = b, b = b.prev; b; b = b.walk(!0))
                  if (3 == b.type || !N.isBlock(b.name)) {
                    r.schema.isValidChild(b.parent.name, "span") &&
              ...
              if (T.invalid) {
                for (
                  ...
                  (f = b), (b = b.parentNode);
                (o = f == h ? h.innerHTML : N.getOuterHTML(f)),
                  (o = d.serialize(
                    u.parse(
                      o.replace(
            ...
            "Indent,Outdent": function (e) {
              ...
              (t = R.indentation),
                ...
                y("InsertUnorderedList") || y("InsertOrderedList")
                  ? x(e)
                  : (R.forced_root_block ||
                      N.getParent(S.getNode(), N.isBlock) ||
                      A.apply("div"),
            ...
            delete: function () {
              ...
              N.isEmpty(e) &&
                (r.setContent(""),
                e.firstChild && N.isBlock(e.firstChild)
            ...
            InsertLineBreak: function (e, t, n) {
              ...
              var v = N.getParent(p, N.isBlock),
                y = v ? v.nodeName.toUpperCase() : "",
                b = v ? N.getParent(v.parentNode, N.isBlock) : null,
              ...
              return (
                h &&
                  "PRE" == y &&
                  (!w || 8 > w) &&
                  l.parentNode.insertBefore(N.doc.createTextNode("\r"), l),
                (u = N.create("span", {}, "&nbsp;")),
          ...
          C(
            {
              ...
              Outdent: function () {
                ...
                if (R.inline_styles) {
                  if (
                    (e = N.getParent(S.getStart(), N.isBlock)) &&
                    parseInt(e.style.paddingLeft, 10) > 0
                  )
                    return m;
                  if (
                    (e = N.getParent(S.getEnd(), N.isBlock)) &&
                    parseInt(e.style.paddingLeft, 10) > 0
                  )
                    return m;
                }
                return (
                  ...
                  y("InsertOrderedList") ||
                  (!R.inline_styles && !!N.getParent(S.getNode(), "BLOCKQUOTE"))
                );
              },
              "InsertUnorderedList,InsertOrderedList": function (e) {
            ...
            o.each(a.getBody().getElementsByTagName("*"), function (e) {
              "SPAN" == e.tagName && e.setAttribute("mce-data-marked", 1),
                !e.hasAttribute("data-mce-style") &&
                  ...
                  a.dom.setAttrib(e, "style", a.dom.getAttrib(e, "style"));
            }),
              t.observe(a.getDoc(), {
                childList: !0,
                attributes: !0,
              ...
              !i ||
                ...
                a.once("touchend", function (e) {
                  ...
                  new Date().getTime() - n > 500 ||
                    ...
                    (o = a.fire("click", o)),
                    o.isDefaultPrevented() ||
                      (a.selection.placeCaretAt(i.clientX, i.clientY),
                      a.nodeChanged()));
                }));
          });
        }
          ...
          (k.prototype = {
              ...
              if (n.getElement() && x.contentEditable) {
                ...
                a &&
                  ...
                  r.hidden_input &&
                    ...
                    (N.insertAfter(
                      N.create("input", { type: "hidden", name: i }),
                      i
                    ),
                    (n.hasHiddenInput = !0)),
            ...
            init: function () {
              ...
              if (
                ...
                N.setAttrib(y, "src", u || 'javascript:""'),
                (t.contentAreaContainer = l.iframeContainer),
                (t.iframeElement = y),
                (s = N.add(l.iframeContainer, y)),
                O)
              )
                try {
                  t.getDoc();
              ...
              l.editorContainer &&
                ((N.get(l.editorContainer).style.display = t.orgDisplay),
                (t.hidden = N.isHidden(l.editorContainer))),
            ...
            initContentBody: function (t) {
              ...
              r.inline || (n.getElement().style.visibility = n.orgVisibility),
                ...
                r.readonly ||
                  (n.inline &&
                    "static" == N.getStyle(m, "position", !0) &&
            ...
            getElement: function () {
              return (
                this.targetElm || (this.targetElm = N.get(this.id)),
                this.targetElm
              );
            },
            getWin: function () {
          ...
          if (
            ...
            for (
              ...
              (p = r[t]),
                ...
                (y = h.maxFlexSize || h[k]),
                "center" === s
                  ? (x[D] = Math.round(i[H] / 2 - h[M] / 2))
                  : "stretch" === s
                  ? ((x[M] = z(h[L] || 0, i[H] - o[P] - o[O])), (x[D] = o[P]))
                  : "end" === s && (x[D] = i[H] - h[M] - o.top),
                h.flex > 0 && (y += h.flex * C),
                (x[E] = y),
                (x[N] = w),
                p.layoutRect(x),
      ...
      return e.extend({
        recalc: function (e) {
          ...
          if (
            ...
            var H = 0,
              M = t.flexWidths;
            if (M) for (d = 0; d < M.length; d++) H += M[d];
            else H = r;
            var L = T / H;
            for (d = 0; r > d; d++) E[d] += M ? M[d] * L : L;
            for (h = g.top, f = 0; n > f; f++) {
              for (
                p = g.left, s = k[f] + D, d = 0;
                r > d &&
