      ...
      return function (f, g) {
          ...
          return (
            ...
            a.walk(
              ...
              function (a) {
                ...
                return 3 == a.nodeType
                  ? (e(
                      L.getParents(a.parentNode, null, b).reverse(),
                      function (a) {
                        g[a.nodeName] &&
                          ((a = i(a, !1)),
        ...
        function E(a, b) {
          ...
          do {
            ...
            if (e.elm != a)
              return (
                K.select(e.elm, !0), L.isEmpty(e.elm) && K.collapse(!0), !0
              );
          } while (e.elm == a);
          return !1;
        }
          ...
          function f() {
            function b(b) {
              ...
              function g(a, b, d, e) {
                ...
                if (-1 === g) {
                  var i =
                    "thead" === d.tagName.toLowerCase() ? 0 : f.length - 1;
                  return f[i];
                }
                return f[g + (a ? -1 : 1)];
              }
          ...
          (n.tableProps = function () {
            ...
            (n.table = function (e) {
              function j() {
                var c;
                l(s, this),
                  (t = a.extend(t, this.toJSON())),
                  a.each(
                    "backgroundColor borderColor".split(" "),
                    function (a) {
                      delete t[a];
                    }
                  ),
                  t["class"] === !1 && delete t["class"],
                  d.undoManager.transact(function () {
                    n ||
                      (n = d.plugins.table.insertTable(
                        t.cols || 1,
                        t.rows || 1
                      )),
                      d.dom.setAttribs(n, {
                      ...
                      s.getAttrib(n, "width")
                        ? s.setAttrib(n, "width", g(t.width))
                        : s.setStyle(n, "width", h(t.width)),
                      s.setStyle(n, "height", h(t.height)),
                      (c = s.select("caption", n)[0]),
                      c && !t.caption && s.remove(c),
                      !c &&
                        t.caption &&
                        ((c = s.create("caption")),
                        (c.innerHTML = b.ie
                      ...
                      i(n),
                      t.align && d.formatter.apply("align" + t.align, {}, n),
                      d.focus(),
                      d.addVisual();
                  });
              }
              var n,
                ...
                t = {};
              e === !0
                ? ((n = s.getParent(d.selection.getStart(), "table")),
                  n &&
                    ((t = {
                      width: g(
                        s.getStyle(n, "width") || s.getAttrib(n, "width")
                      ),
                      height: g(
                        s.getStyle(n, "height") || s.getAttrib(n, "height")
                      ),
                ...
                : ((o = { label: "Cols", name: "cols" }),
                  (p = { label: "Rows", name: "rows" })),
                d.settings.table_class_list &&
                  (t["class"] &&
                    (t["class"] = t["class"].replace(
