...
(function ($) {
  ...
  function postPlotDraw() {
    ...
    if (
      ...
      this.plugins.pyramidRenderer.highlightCanvas
    ) {
    ...
    this.eventCanvas._elem.before(
      this.plugins.pyramidRenderer.highlightCanvas.createElement(
        this._gridPadding,
        "jqplot-pyramidRenderer-highlight-canvas",
  ...
  function highlight(plot, sidx, pidx, points) {
    ...
    if (
      s.synchronizeHighlight !== false &&
      plot.series.length >= s.synchronizeHighlight &&
      s.synchronizeHighlight !== sidx
    ) {
  ...
  function handleMove(ev, gridpos, datapos, neighbor, plot) {
    if (neighbor) {
      ...
      if (
        ...
        !(
          ins[0] == plot.plugins.pyramidRenderer.highlightedSeriesIndex &&
