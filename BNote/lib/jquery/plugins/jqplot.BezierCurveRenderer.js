...
(function ($) {
  ...
  $.jqplot.BezierCurveRenderer.prototype.constructor =
    ...
    if (data.length == 2) {
      if (idx == 0) {
        this.gridData = [
          ...
          [
            xp.call(this._xaxis, data[1][0]),
            yp.call(this._yaxis, data[1][1]),
            xp.call(this._xaxis, data[1][2]),
            yp.call(this._yaxis, data[1][3]),
            xp.call(this._xaxis, data[1][4]),
            yp.call(this._yaxis, data[1][5]),
          ],
          [
            xp.call(this._xaxis, data[1][4]),
            yp.call(this._yaxis, this._yaxis.min),
          ],
          [
            xp.call(this._xaxis, data[0][0]),
            yp.call(this._yaxis, this._yaxis.min),
          ],
        ];
      } else {
        ...
        this.gridData = [
          ...
          [
            xp.call(this._xaxis, psd[1][2]),
            yp.call(this._yaxis, psd[1][3]),
            xp.call(this._xaxis, psd[1][0]),
            yp.call(this._yaxis, psd[1][1]),
            xp.call(this._xaxis, psd[0][0]),
            yp.call(this._yaxis, psd[0][1]),
          ],
        ];
      }
    } else {
      if (idx == 0) {
        this.gridData = [
          ...
          [
            xp.call(this._xaxis, data[1][0]),
            yp.call(this._yaxis, data[1][1]),
            xp.call(this._xaxis, data[2][0]),
            yp.call(this._yaxis, data[2][1]),
            xp.call(this._xaxis, data[3][0]),
            yp.call(this._yaxis, data[3][1]),
          ],
          [
            xp.call(this._xaxis, data[3][1]),
            yp.call(this._yaxis, this._yaxis.min),
          ],
          [
            xp.call(this._xaxis, data[0][0]),
        ...
        this.gridData = [
          ...
          [
            xp.call(this._xaxis, psd[2][0]),
            yp.call(this._yaxis, psd[2][1]),
            xp.call(this._xaxis, psd[1][0]),
            yp.call(this._yaxis, psd[1][1]),
            xp.call(this._xaxis, psd[0][0]),
            yp.call(this._yaxis, psd[0][1]),
  ...
  $.jqplot.BezierCurveRenderer.prototype.drawShadow = function (
    ctx,
    gd,
    options
  ) {
  ...
  $.jqplot.BezierAxisRenderer.prototype.constructor =
    $.jqplot.BezierAxisRenderer;
