...
**Strategy:**
- **Separate Modern UI**: Created `/next` directory as a parallel implementation alongside the existing UI
- **REST API Layer**: Built lightweight JSON API (`/next/api/`) that wraps existing BNote data/logic layers without modification
