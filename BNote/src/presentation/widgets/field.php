...
class Field implements iWriteable
{
     ...
     */
    public function __construct($name, $default, $type)
    {
        $this->name = $name;
    ...
    {
        switch ($this->type) {
            case 0:return $this->Textarea();
                break;
            case 1:return $this->Integerfield();
                break;
            case 2:return $this->Decimalfield();
                break;
            case 4:return $this->Datefield();
                break;
            case 5:return $this->Timefield();
                break;
            case 6:return $this->Datetimefield();
                break;
            case 9:return $this->Passwordfield();
                break;
            case 10:return $this->Checkboxfield();
                break;
            case 12:return $this->Filefield();
                break;
            case 96:return $this->TimeSelector();
                break;
            case 97:return $this->DatetimeSelector();
                break;
            case 98:return $this->tinyMCE();
                break;
            case 99:return $this->UneditableField();
                break;
    ...
    private function Textfield()
    {
        ...
        return '<input type="text"' . $css . ' size="' . $this->TEXTLENGTH . '" name="' . $this->name . '" id="' . $this->name . '" value="' . $this->default_value . '" />' . "\n";
    }
    ...
    private function Textarea()
    {
        ...
        return '<textarea name="' . $this->name . '" id="' . $this->name . '" cols="' . $this->cols . '" rows="' . $this->rows . '"' . $css . '>' . $this->default_value . '</textarea>' . "\n";
    }

    private function tinyMCE()
    {
        $ret = '<textarea id="tinymce" name="' . $this->name . '" id="' . $this->name . '" cols="' . $this->cols . '" rows="' . $this->rows . '">';
    ...
    private function Datefield()
    {
        ...
        return '<input class="dateChooser' . $css . '" type="text" size="' . $this->DATELENGTH . '" name="' . $this->name . '" id="' . $this->name . '" value="' . $this->default_value . '" />' . "\n";
    }
    ...
    private function Datetimefield()
    {
        ...
        return '<input class="datetimeChooser' . $css . '" type="text" size="' . ($this->DATELENGTH + 6) . '" name="' . $this->name . '" id="' . $this->name . '" value="' . $this->default_value . '" />' . "\n";
    }
    ...
    private function Timefield()
    {
        ...
        return '<input type="text" class="' . $css . '"size="' . ($this->DATELENGTH - 4) . '" name="' . $this->name . '" id="' . $this->name . '" value="' . $this->default_value . '" />' . "\n";
    }
    ...
    private function Decimalfield()
    {
        ...
        return '<input type="text"  class="' . $css . '"size="' . $this->DECIMALLENGTH . '" name="' . $this->name . '" id="' . $this->name . '" value="' . $this->default_value . '" />' . "\n";
    }
    ...
    private function Integerfield()
    {
        ...
        return '<input type="text"  class="' . $css . '"size="' . $this->INTEGERLENGTH . '" name="' . $this->name . '" id="' . $this->name . '" value="' . $this->default_value . '" />' . "\n";
    }
    ...
    private function Passwordfield()
    {
        ...
        return '<input type="password"  class="' . $css . '"size="' . $this->TEXTLENGTH . '" name="' . $this->name . '" id="' . $this->name . '" value="' . $this->default_value . '" />' . "\n";
    }
    ...
    private function Checkboxfield()
    {
        ...
        return '<input type="checkbox"  class="' . $css . '"name="' . $this->name . '" id="' . $this->name . '" ' . $checked . '/>';
    }
    ...
    private function UneditableField()
    {
        ...
        $hidden = '<input type="hidden"  class="' . $css . '"name="' . $this->name . '" id="' . $this->name . '" value="' . $this->default_value . '" />';
    ...
    private function Filefield()
    {
        ...
        return '<input type="file"  class="' . $css . '"name="' . $this->name . '" id="' . $this->name . '" />';
    }
    ...
    private function DatetimeSelector()
    {
        ...
        // hour field
        $hourfield = '<select class="form-control" name="' . $this->name . '_hour"' . $css_hour . '>';
        for ($h = 6; $h <= 23; $h++) {
            $sel = ($h == $hour) ? ' selected' : '';
        ...
        // minute field
        $minutefield = '<select class="form-control" name="' . $this->name . '_minute"' . $css_min . '>';
        for ($m = 0; $m <= 45; $m = $m + 15) {
            $mf = ($m < 10) ? "00" : $m;
