...
<HEAD>
 ...
 <link type="text/css" href='<?php echo $GLOBALS["DIR_LIB"]; ?>fullcalendar/core/main.css' rel='stylesheet' />
 <link type="text/css" href='<?php echo $GLOBALS["DIR_LIB"]; ?>fullcalendar/daygrid/main.css' rel='stylesheet' />
 ...
 <script src='<?php echo $GLOBALS["DIR_LIB"]; ?>fullcalendar/core/main.js'></script>
 <script src='<?php echo $GLOBALS["DIR_LIB"]; ?>fullcalendar/daygrid/main.js'></script>
