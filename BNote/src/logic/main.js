...
tinyMCE.init({
  ...
  plugins: "textcolor",
  toolbar:
    "bold italic underline | alignleft aligncenter alignright alignjustify | bullist numlist | forecolor backcolor | fontsizeselect",
  menubar: false,
  statusbar: false,
});
...
tinyMCE.init({
  ...
  toolbar:
    "preview | bold italic underline | alignleft aligncenter alignright alignjustify | bullist numlist | forecolor backcolor | fontsizeselect | cut copy paste | undo redo | hr | print",
  statusbar: false,
  tools: "inserttable",
});
