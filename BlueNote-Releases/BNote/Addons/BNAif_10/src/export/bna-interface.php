...
/**
 * Interface definition for BlueNote App (BNA) connection.
 * @author Matti
 *
 */
interface iBNA {
	 ...
	 * @param Integer $rid Rehearsal ID
	 * @param Integer $uid User ID
	 * @param Integer $part 1=participates, 0=does not participate, -1=not chosen
...
/**
 * Scheme for BlueNote Interface implementation.
 * @author Matti
 *
 */
