...
include $DIR_WIDGETS . "error.php";

// Application Connection
$sd = new Systemdata();
$swname = $sd->getApplicationName();
$db = $sd->dbcon;
$regex = $sd->regex;
...
<html>
 <head>
  ...
  <title><?php echo $swname; ?> | Registrierung</title>
		...
		<div id="registration">
			...
			if(isset($_POST["register"])) {
				...
				if($sd->autoUserActivation()) {
					...
					$linkurl = $sd->getSystemURL() . "/src/export/useractivation?uid=$uid&email=" . $_POST["email"];
			...
			<table class="login">
				...
				<TR>
					...
					<TD class="loginInput"><input name="login" type="text" size="25" onChange="validateInput(this, 'short_name');" /></TD>
				</TR>
				<TR>
