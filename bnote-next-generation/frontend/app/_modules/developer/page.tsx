...
function DeveloperModulePageContent() {
  ...
  return (
    <PageContent className="px-1 md:px-4 space-y-8">
      ...
      <section className="space-y-3">
        <h2 className="text-sm font-semibold uppercase tracking-wide text-base-content/60">PHP (localhost)</h2>
        <p className="text-xs text-base-content/60">
          These endpoints need PHP on your machine and only respond on loopback (127.0.0.1 / ::1). Set <code className="text-xs">NEXT_PUBLIC_API_BASE</code> if the API is not same-origin as this app.
        </p>
