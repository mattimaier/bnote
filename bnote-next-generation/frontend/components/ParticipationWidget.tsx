  ...
  if (loading) {
    return (
      <div className="flex flex-col gap-2 items-end">
        <p className="text-xs font-medium opacity-50" style={{ color: "var(--muted-foreground)" }}>
          {t("js.event.participation")}
        </p>
        <div className="h-10 w-10 rounded-full border-2 border-[var(--border)] animate-pulse" />
      </div>
    );
  }
