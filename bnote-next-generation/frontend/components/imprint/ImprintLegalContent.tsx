    ...
    <div className="space-y-5">
      <section className="rounded-lg border border-base-300 bg-base-200 p-5">
        ...
        <p className="text-sm leading-6 text-base-content/85">
          ...
          <br />
          Web:{" "}
          <a href="https://www.bnote.info" target="_blank" rel="noopener noreferrer" className="link link-primary">
            www.bnote.info
          </a>
        </p>
      </section>
