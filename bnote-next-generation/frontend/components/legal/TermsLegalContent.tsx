/**
 * Terms / privacy information page content (from legacy BNote data/terms.html).
 */

const TERMS_HTML_BODY = `
<p>
...
<h5>Welche personenbezogenen Daten werden gespeichert und verarbeitet?</h5>
<p>
Bei der Installation von BNote kann der Administrator selbst entscheiden wie viel Daten er preisgibt. Es können folgende Daten über ein <strong>Ensemble</strong> (z.B. Personengruppe) erfasst werden:
</p>
<ul class="classic list-disc pl-6">
	<li>Name</li>
...
<ul class="classic list-disc pl-6">
	...
	<li>Außerdem kann der Administrator weitere Felder definieren (ab BNote 3.3.0), sodass weitere Daten über die Personen gespeichert werden können.</li>
</ul>
...
<h5>Wer hat Einsicht in die Daten?</h5>
<p>
...
<h5>Wie werden die Daten geschützt? Welche Sicherheitsmaßnahmen sind zu beachten?</h5>
<p>
...
<h5>Wie kann jedes Ensemble-Mitglied seine Daten bearbeiten/einsehen/löschen?</h5>
<p>
...
export function TermsLegalContent() {
  return (
    <div
      className="prose prose-sm max-w-none text-base-content dark:prose-invert [&_h4]:text-lg [&_h4]:font-semibold [&_h5]:mt-6 [&_h5]:text-base [&_h5]:font-semibold"
      dangerouslySetInnerHTML={{ __html: TERMS_HTML_BODY.trim() }}
    />
  );
}
