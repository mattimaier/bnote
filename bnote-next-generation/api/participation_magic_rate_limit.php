<?php
/**
 * File-based rate limiter for public participation magic-link applies (per IP).
 *
...
final class ParticipationMagicRateLimit {
    ...
    public static function consumeOr429(): void {
        ...
        $path = $dir . '/participation_magic_' . $key . '.json';
        ...
        if (count($times) >= self::MAX_ATTEMPTS) {
            Response::error('participation_magic_rate_limited', 429);
        }
