...
class TextNormalizer {
    ...
    public static function logStats($module, $action, $stats) {
        ...
        $samples = isset($stats['samples']) && is_array($stats['samples'])
            ? implode(',', $stats['samples'])
            : '';

        error_log('TextNormalizer: module=' . $module . ' action=' . $action . ' normalized=' . $count . ' fields=' . $samples);
