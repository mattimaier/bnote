...
final class MailHtmlShell
{
  ...
  public static function wrapTransactional(
    ...
    $styleBlock =
      ...
      "html,body{margin:0!important;padding:0!important;width:100%!important;background-color:" .
      $pageBg .
      " !important;-webkit-text-size-adjust:100%;text-size-adjust:100%;}" .
      ".em-root{font-family:" .
      $ff .
      ";font-size:" .
      $fs .
      ...
      $tm .
      ";}" .
      ".em-body .em-lead{color:" .
      $tc .
      ";}" .
      ".em-body .em-text-secondary{color:" .
      $ts .
      ";}" .
      ".em-body .em-section-title{color:" .
      $tc .
      ";font-size:17px;font-weight:700;line-height:1.3;}" .
      ".em-body .em-section-p{color:" .
      $tc .
      ";}" .
      ".em-body .em-section-p-muted{color:" .
      $tm .
      ";font-size:14px;}" .
      ".em-body .em-list{color:" .
      $tc .
      ";}" .
      ".em-body .em-list-plain{list-style:none!important;padding-left:0!important;margin:16px 0;color:" .
      $tc .
      ";}" .
      ".em-body .em-list-plain li{margin:0 0 8px;}" .
      ".em-surface{background:" .
      $surfaceBg .
      ...
      $surfaceText .
      " !important;}" .
      ".em-surface-code{background:" .
      $surfaceBg .
      " !important;border:1px solid " .
      $surfaceBorder .
      " !important;color:" .
      $surfaceText .
      " !important;border-radius:4px;padding:0 4px;}" .
      ".em-surface-quote{border-left:3px solid " .
      $surfaceQuoteBorder .
      " !important;color:" .
      $surfaceQuoteText .
      " !important;}" .
      ".em-mark{background:" .
      $surfaceHighlight .
      " !important;color:inherit !important;padding:0 2px;border-radius:2px;}" .
      ".em-chat-avatar{background-color:" .
      $chatAvatarBg .
      " !important;color:" .
      $chatAvatarText .
      " !important;}" .
      ".em-chat-bubble{background-color:" .
      $surfaceBg .
      " !important;border:1px solid " .
      $surfaceBorder .
      " !important;color:" .
      ...
      $tc .
      " !important;}" .
      ".em-participation-track{border:1px solid " .
      $border .
      " !important;background:" .
      $surfaceBorder .
      " !important;}" .
      ".em-hr{border:none;border-top:1px solid " .
      $border .
      ";margin:24px 0;}" .
      ".em-body p a,.em-body p a:link,.em-body p a:visited{color:" .
      $primary .
      " !important;text-decoration:underline !important;font-weight:600 !important;}" .
      "a.em-link,a.em-link:link,a.em-link:visited{color:" .
      $primary .
      " !important;text-decoration:underline !important;font-weight:600 !important;}" .
      ".em-card{max-width:" .
      $mwc .
      ...
      ".em-h1{margin:0;font-size:20px;font-weight:700;color:" .
      $tc .
      ";line-height:1.25;}" .
      ".em-cta-td{text-align:center !important;vertical-align:middle;}" .
      ".em-cta-td a,.em-cta-td a:link,.em-cta-td a:visited{color:" .
      $onPrimary .
      " !important;text-decoration:none !important;font-weight:600 !important;text-align:center !important;}" .
      ...
      $textD .
      " !important;}" .
      ".em-shell-pad{background-color:" .
      $pageD .
      " !important;}" .
      ".em-card{background-color:" .
      $cardD .
      " !important;background:" .
      $cardD .
      ...
      $shD .
      " !important;}" .
      ".em-head-pad{border-bottom-color:" .
      $bdD .
      " !important;}" .
      ".em-body-pad.em-body{color:" .
      $textD .
      " !important;}" .
      ".em-foot-pad{border-top-color:" .
      $bdD .
      " !important;}" .
      ".em-h1{color:" .
      $textD .
      ...
      $tmD .
      " !important;}" .
      ".em-body .em-lead,.em-body .em-section-p,.em-body .em-list,.em-body .em-list-plain,.em-body .em-list-plain li{color:" .
      $textD .
      " !important;}" .
      ".em-body .em-text-secondary{color:" .
      $tsD .
      ...
      $tmD .
      " !important;}" .
      ".em-surface,.em-surface-pre{background:" .
      $surfaceBgD .
      " !important;border-color:" .
      $surfaceBorderD .
      " !important;color:" .
      ...
      $surfaceTextD .
      " !important;}" .
      ".em-surface-quote{border-left-color:" .
      $surfaceQuoteBorderD .
      " !important;color:" .
      $surfaceQuoteTextD .
      " !important;}" .
      ...
      $textD .
      " !important;}" .
      ".em-participation-track{border-color:" .
      $bdD .
      " !important;background:" .
      $surfaceBorderD .
      " !important;}" .
      ".em-hr{border-top-color:" .
      $bdD .
      " !important;}" .
      "}" .
      "</style>";
    ...
    if ($companySublineHtml !== "") {
      $sublineBlock =
        '<p class="em-muted" style="margin:8px 0 0;font-size:' . $fsSmall . ';">' . $companySublineHtml . "</p>";
    }
    ...
    if ($logoImgSrc !== "") {
      ...
      $logoBlock =
        ...
        $escSrc .
        '" width="' .
        htmlspecialchars($lw, ENT_QUOTES, "UTF-8") .
        '" height="' .
        htmlspecialchars($lhLogo, ENT_QUOTES, "UTF-8") .
        '" alt="BNote" style="display:block;border:0;outline:none;max-width:100%;height:auto;">';
    }

    $ctaBlock = "";
    if ($ctaHref !== null && $ctaLabel !== null && $ctaHref !== "" && $ctaLabel !== "") {
      $ctaBlock =
        '<table role="presentation" class="em-cta" cellspacing="0" cellpadding="0" width="100%" style="margin:24px 0 0;">' .
        '<tr><td align="center" style="padding:0;">' .
        '<table role="presentation" class="em-cta-inner" cellspacing="0" cellpadding="0" border="0" style="margin:0 auto;">' .
        '<tr><td class="em-cta-td" align="center" valign="middle" style="text-align:center;border-radius:' .
        $rBtn .
        ";background-color:" .
        $primary .
        ';">' .
        ...
        ";color:" .
        $onPrimary .
        " !important;text-decoration:none !important;font-weight:600;font-size:" .
        $fs .
    ...
    if ($base !== "") {
      ...
      $appBlock =
        '<p style="margin:12px 0 0;font-size:' .
        $fsFoot .
        ';">' .
        '<a class="em-link" href="' .
        $urlEsc .
        '" style="color:' .
        $primary .
        ' !important;font-weight:600;text-decoration:underline !important;word-break:break-all;">' .
        $openLabel .
        "</a></p>";
    } else {
      $hint = htmlspecialchars(
        MailI18n::t("mail.footer.openAppUnavailable", $locale),
    ...
    $footerInner =
      '<div class="em-foot" style="font-size:' .
      $fsFoot .
      ";line-height:" .
      $lh .
      ';">' .
    ...
    return '<!DOCTYPE html><html lang="' .
      htmlspecialchars($htmlLang, ENT_QUOTES, "UTF-8") .
      ...
      $styleBlock .
      "</head>" .
      '<body class="em-root" style="margin:0;padding:0;width:100%;font-family:' .
      $ff .
      ";font-size:" .
      $fs .
      ";line-height:" .
      ...
      $pageBgEsc .
      ';">' .
      '<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="width:100%;background-color:' .
      $pageBgEsc .
      ';" bgcolor="' .
      $pageBgEsc .
      '">' .
      '<tr><td align="center" class="em-shell-pad" style="padding:24px 16px;background-color:' .
      $pageBgEsc .
      ';" bgcolor="' .
      $pageBgEsc .
      '">' .
      '<table role="presentation" class="em-card" width="100%" cellpadding="0" cellspacing="0" style="max-width:' .
      htmlspecialchars($mwc, ENT_QUOTES, "UTF-8") .
      ...
      $shadow .
      ';">' .
      '<tr><td class="em-head-pad" style="padding:24px 24px 16px;border-bottom:1px solid ' .
      $border .
      ';">' .
      '<table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr>' .
      '<td valign="middle" style="padding-right:12px;">' .
      '<h1 class="em-h1" style="margin:0;font-size:20px;font-weight:700;color:' .
      $tc .
      ';line-height:1.25;">' .
      $headlineHtml .
      "</h1>" .
      ...
      ($logoBlock !== ""
        ? '<td valign="top" width="' .
          htmlspecialchars($logoColW, ENT_QUOTES, "UTF-8") .
          '" align="right">' .
          $logoBlock .
          "</td>"
        : "") .
      "</tr></table></td></tr>" .
      '<tr><td class="em-body-pad em-body" style="padding:24px;color:' .
      $tc .
      ';">' .
      $bodyHtml .
      $ctaBlock .
      "</td></tr>" .
      '<tr><td class="em-foot-pad" style="padding:16px 24px 24px;border-top:1px solid ' .
      $border .
      ';">' .
      $footerInner .
      "</td></tr>" .
