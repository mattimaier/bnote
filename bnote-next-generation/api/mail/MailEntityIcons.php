...
final class MailEntityIcons
{
  ...
  private static function svgCheckSquare(): string
  {
    ...
    return self::svgWrap('<path d="M9 12l2 2l4 -4" />' . '<rect x="4" y="4" width="16" height="16" rx="2" />');
  }
  ...
  {
    return self::svgWrap(
      '<path d="M12 21s7-4.5 7-10a7 7 0 1 0-14 0c0 5.5 7 10 7 10z" />' . '<circle cx="12" cy="11" r="2.5" />',
    );
  }

  private static function svgCalendar(): string
  {
    return self::svgWrap('<rect x="3" y="5" width="18" height="16" rx="2" />' . '<path d="M16 3v4M8 3v4M3 11h18" />');
  }

  private static function svgTerminal(): string
  {
    return self::svgWrap('<rect x="3" y="4" width="18" height="16" rx="2" />' . '<path d="M7 9l3 3l-3 3M13 15h4" />');
  }
  ...
  {
    return self::svgWrap('<path d="M12 22s8-4 8-10V6l-8-4l-8 4v6c0 6 8 10 8 10z" />' . '<path d="M9 12l2 2l4-4" />');
  }

  private static function svgUser(): string
  {
    return self::svgWrap('<circle cx="12" cy="8" r="4" />' . '<path d="M4 20a8 8 0 0 1 16 0" />');
  }

  private static function svgPackage(): string
  {
    return self::svgWrap('<path d="M3 7l9-4l9 4v10l-9 4l-9-4z" />' . '<path d="M3 7l9 4l9-4M12 11v10" />');
  }

  private static function svgShirt(): string
  {
    return self::svgWrap('<path d="M7 4l2 2h6l2-2l4 3l-3 4h-2v9H8v-9H6L3 7z" />');
  }
}
