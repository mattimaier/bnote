...
final class MailPreviewFixtures
{
  ...
  public static function commentDiscussionRehearsalShort(string $locale = "en"): array
  {
    ...
    return [
      ...
      "thread" => [
        [
          "author" => "Alex M.",
          "message" => "Can we move the warm-up to 18:30?",
          "created_at" => "2026-03-28 10:00:00",
          "is_new" => false,
        ],
        [
          "author" => "Sam K.",
          "message" => "Works for me.\nSee https://maps.example.com/rehearsal",
          "created_at" => "2026-03-28 11:15:00",
          "is_new" => false,
        ],
        [
          "author" => "River P.",
          "message" => "Thanks — I added the room code in the calendar.",
  ...
  public static function commentDiscussionConcert(string $locale = "en"): array
  {
    ...
    return [
      ...
      "thread" => [
        [
          "author" => "Alex M.",
          "message" => "Load-in is 14:00 — who can help with the risers?",
          "created_at" => "2026-03-28 09:00:00",
          "is_new" => false,
        ],
        [
          "author" => "Sam K.",
          "message" => "I can be there from 13:30.",
          "created_at" => "2026-03-29 16:20:00",
          "is_new" => false,
        ],
        [
          "author" => "Jordan W.",
          "message" => "Rain plan: we move to the hall — I will update the calendar entry.",
          "created_at" => "2026-03-30 08:05:00",
          "is_new" => true,
        ],
      ],
    ];
  ...
  public static function commentDiscussionVote(string $locale = "en"): array
  {
    ...
    return [
      ...
      "thread" => [
        [
          "author" => "Jamie R.",
          "message" => "Option A has better flow for the second half.",
          "created_at" => "2026-03-25 08:00:00",
          "is_new" => false,
        ],
        [
          "author" => "Morgan T.",
          "message" => "I prefer B — more rest between pieces.",
          "created_at" => "2026-03-26 19:30:00",
          "is_new" => false,
        ],
        [
          "author" => "Casey L.",
          "message" => "We need a decision by Friday; please vote in the app.",
          "created_at" => "2026-03-30 07:45:00",
          "is_new" => true,
        ],
      ],
    ];
  ...
  public static function commentDiscussionSingleNew(string $locale = "en"): array
  {
    ...
    return [
      ...
      "thread" => [
        [
          "author" => "Taylor N.",
          "message" => "Doors open at 19:00 — please arrive by 18:15 for sound check.",
  ...
  public static function eventInfoConcert(string $locale = "en"): array
  {
    ...
    return [
      ...
      "detailLines" => [
        ...
        [
          "label" => MailI18n::t("mail.eventInfo.detailDresscode", $locale),
          "value" => MailI18n::t("mail.eventInfo.defaultDresscode", $locale),
        ],
      ],
  ...
  public static function escalationDropoutCritical(string $locale = "en"): array
  {
    return [
      ...
      "gaps" => [["instrument_name" => "Bass", "current" => 0, "minimum" => 1]],
