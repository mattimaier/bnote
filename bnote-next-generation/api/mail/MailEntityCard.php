...
final class MailEntityCard
{
  ...
  public static function entityHeaderHtml(
    ...
    $iconFill = htmlspecialchars(MailEntityColors::mixWithWhite($iconBgRaw, 0.2), ENT_QUOTES, "UTF-8");
    ...
    if (isset($card["icon_inner_html"]) && is_string($card["icon_inner_html"]) && $card["icon_inner_html"] !== "") {
      ...
      $iconInner =
        '<span style="font-size:20px;line-height:38px;display:block;text-align:center;">' . $iconChar . "</span>";
    }
    ...
    if ($loc !== "") {
      $locBlock =
        ...
        htmlspecialchars($fsSmall, ENT_QUOTES, "UTF-8") .
    ...
    $iconCell =
      $iconBadgePng !== null
        ? '<tr><td align="center" valign="middle" width="40" height="40" ' .
          ...
          "</td></tr>"
        : '<tr><td align="center" valign="middle" width="40" height="40" ' .
          'style="width:40px;height:40px;border-radius:12px;border:1px solid ' .
          $iconBorder .
          ";background-color:" .
          $iconFill .
          ";color:" .
    ...
    $inner =
      ...
      '<span style="font-size:22px;font-weight:700;line-height:1.25;color:' .
      $textEsc .
      ';">' .
      $title .
      "</span>" .
      ...
      "</span>" .
      "</td></tr></table>" .
      '<p style="margin:6px 0 0;font-size:' .
      htmlspecialchars($fsSmall, ENT_QUOTES, "UTF-8") .
      ";line-height:1.45;color:" .
      $mutedEsc .
      ';">' .
    ...
    if ($href !== "") {
      ...
      $padded =
        ...
        $labelEsc .
        '" ' .
        'style="display:block;text-decoration:none;color:inherit;outline:none;">' .
        $inner .
        "</a>";
    }
