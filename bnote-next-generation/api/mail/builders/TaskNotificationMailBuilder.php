    ...
    $descHtml =
      $descRaw !== ""
        ? '<p style="margin:12px 0 0;font-size:' .
          htmlspecialchars(MailDesignTokens::get("fontSizeBody"), ENT_QUOTES, "UTF-8") .
          ";line-height:1.5;color:" .
          htmlspecialchars(MailDesignTokens::get("text"), ENT_QUOTES, "UTF-8") .
          ';">' .
          nl2br(htmlspecialchars($descRaw, ENT_QUOTES | ENT_SUBSTITUTE, "UTF-8"), false) .
          "</p>"
        : "";
