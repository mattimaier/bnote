...
final class GenericEmailComposerMailBuilder
{
  ...
  public static function build(
    ...
    $subjectFinal =
      trim($subject) !== ""
        ? trim($subject)
        : MailI18n::interpolate(MailI18n::t("mail.genericComposer.subjectFallback", $locale), [
          "orgPrefix" => $orgPrefix,
        ]);

    $headlineRaw =
      trim($subjectHeadline) !== "" ? trim($subjectHeadline) : MailI18n::t("mail.shell.headlineGenericEmail", $locale);
