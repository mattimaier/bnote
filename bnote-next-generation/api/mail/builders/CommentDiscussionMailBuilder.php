...
final class CommentDiscussionMailBuilder
{
  ...
  public static function build(
    ...
    if (count($thread) > 1) {
      $threadTitle =
        '<p class="em-section-title" style="margin:20px 0 12px;font-size:17px;font-weight:700;">' .
        htmlspecialchars(
          MailI18n::t("mail.commentDiscussion.threadHeading", $locale),
    ...
    if ($openUrl === "") {
      $noLink =
        '<p class="em-muted" style="font-size:13px;margin:16px 0 0;">' .
        htmlspecialchars(
          MailI18n::t("mail.commentDiscussion.noDeepLink", $locale),
          ENT_QUOTES | ENT_SUBSTITUTE,
          "UTF-8",
        ) .
        "</p>";
    ...
    $inner =
      $greetingHtml .
      '<p class="em-lead" style="margin:0 0 16px;">' .
      $intro .
      "</p>" .
      $headerHtml .
      $threadTitle .
    ...
    $headline = htmlspecialchars(
      MailI18n::t("mail.shell.headlineCommentDiscussion", $locale),
      ENT_QUOTES | ENT_SUBSTITUTE,
      "UTF-8",
    );
  ...
  private static function bubbleRow(
    ...
    $inner =
      ...
      '<div class="em-chat-avatar" style="width:36px;height:36px;border-radius:9999px;background-color:' .
      $avatarBg .
      ";color:" .
      $avatarFg .
      ';font-weight:700;font-size:14px;line-height:36px;text-align:center;">' .
      $initialEsc .
      "</div>" .
      "</td>" .
      '<td valign="top" style="padding:0;">' .
      '<p style="margin:0 0 6px;font-size:' .
      $fsSmallEsc .
      ...
      $when .
      "</span></p>" .
      '<div class="em-chat-bubble" style="display:inline-block;max-width:100%;border-radius:16px;padding:10px 14px;background-color:' .
      $bubbleBg .
      ";border:1px solid " .
      $bubbleBd .
      ";color:" .
    ...
    if ($isNew) {
      $newLabel = htmlspecialchars(
        MailI18n::t("mail.commentDiscussion.newCommentLabel", $locale),
        ENT_QUOTES | ENT_SUBSTITUTE,
        "UTF-8",
      );
      ...
      return '<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 18px;">' .
        ...
        $newCommentFrameBgEsc .
        ';overflow:hidden;">' .
        '<div class="em-new-comment-head" style="padding:12px 14px 10px;border-bottom:1px solid ' .
        $accentEsc .
        ';">' .
        '<span style="font-size:11px;font-weight:800;letter-spacing:0.12em;text-transform:uppercase;color:' .
        $accentEsc .
        ';">' .
        $newLabel .
        "</span>" .
