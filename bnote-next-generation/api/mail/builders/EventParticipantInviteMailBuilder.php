...
final class EventParticipantInviteMailBuilder
{
  ...
  public static function build(
    ...
    $headline = htmlspecialchars(
      MailI18n::t("mail.shell.headlineEventInvite", $locale),
  ...
  private static function participationBlockHtml(
    ...
    $widgetLabel = htmlspecialchars(
      MailI18n::t("js.event.participation", $locale),
      ENT_QUOTES | ENT_SUBSTITUTE,
      "UTF-8",
    );
    $labelRow =
      '<p style="margin:0 0 8px;font-size:12px;font-weight:500;line-height:1.25;color:' .
      $mutedEsc .
      ';">' .
      $widgetLabel .
      "</p>";
    ...
    foreach ($specs as $i => $spec) {
      ...
      $cells[] =
        ...
        $sz .
        "px;" .
        "border-radius:50%;border-width:1px;border-style:solid;border-color:" .
        $bd .
        ";" .
        "background-color:" .
        $bg .
    ...
    if ($magicExpiresDisplay !== null && trim($magicExpiresDisplay) !== "") {
      ...
      $hintRow =
        '<tr><td align="left" style="padding:10px 0 0;">' .
  ...
  private static function buildPlain(
    ...
    if ($hasMagic) {
      ...
      if ($magicExpiresDisplay !== null && trim($magicExpiresDisplay) !== "") {
        $plain .=
          MailI18n::interpolate(MailI18n::t("mail.eventInvite.magicLinksValidityPlain", $locale), [
            "until" => trim($magicExpiresDisplay),
          ]) . "\n";
      }
      $plain .= "\n";
  ...
  public static function buildForPreview(
    ...
    if ($magic === "") {
      $magic = NextGenParticipationToken::formatApproxExpiryForMail(
        $locale,
        NextGenParticipationToken::defaultMaxTtlSeconds(),
      );
    }
