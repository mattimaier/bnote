...
final class EscalationResolvedMailBuilder
{
  ...
  public static function build(
    ...
    $headline = htmlspecialchars(
      MailI18n::t("mail.shell.headlineEscalationResolved", $locale),
    ...
    $ctaLabel =
      $eventUrl !== ""
        ? htmlspecialchars(
          MailI18n::t("mail.escalationResolved.ctaOpenEvent", $locale),
          ENT_QUOTES | ENT_SUBSTITUTE,
          "UTF-8",
        )
        : null;
  ...
  private static function resolvedBannerHtml(string $locale): string
  {
    ...
    return '<div style="margin:0 0 12px;padding:10px 12px;border:1px solid ' .
      ...
      ';border-radius:10px;">' .
      '<span style="display:inline-flex;align-items:center;gap:6px;padding:3px 8px;border-radius:999px;border:1px solid ' .
      htmlspecialchars($border, ENT_QUOTES | ENT_SUBSTITUTE, "UTF-8") .
      ...
      "<span>" .
      htmlspecialchars(
        MailI18n::t("mail.escalationResolved.statusBadge", $locale),
        ENT_QUOTES | ENT_SUBSTITUTE,
        "UTF-8",
      ) .
      "</span>" .
  ...
  private static function participationLine(string $locale, ?array $counts): string
  {
    ...
    return '<p style="margin:10px 0 0;color:' .
