<?php
/**
 * File-based rate limiter for public password-reset requests (per IP).
 * Same window/limits as RegisterRateLimit.
 *
...
class PasswordResetRateLimit {
    ...
    public static function consumeOr429(): void {
        ...
        if (count($times) >= self::MAX_ATTEMPTS) {
            Response::error('password_reset_rate_limited', 429);
        }
