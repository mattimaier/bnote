...
echo json_encode(
  [
    ...
    "mailDebug" => [
      ...
      "previewCommentDiscussionRehearsalShortEn" =>
        $apiBase . "/mail_preview.php?template=comment_discussion_rehearsal_short&locale=en",
      "previewCommentDiscussionConcertEn" =>
        $apiBase . "/mail_preview.php?template=comment_discussion_concert&locale=en",
